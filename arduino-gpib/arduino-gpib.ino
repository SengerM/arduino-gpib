 ...
 */
#define DIO1  5  /* GPIB 1  : I/O data bit 1     - Arduino PORTC bit 0 */
#define DIO2  4  /* GPIB 2  : I/O data bit 2     - Arduino PORTC bit 1 */
#define DIO3  3  /* GPIB 3  : I/O data bit 3     - Arduino PORTC bit 2 */
#define DIO4  2  /* GPIB 4  : I/O data bit 4     - Arduino PORTC bit 3 */
#define DIO5  7  /* GPIB 13 : I/O data bit 5     - Arduino PORTC bit 4 */
